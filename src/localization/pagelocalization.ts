...
const resources = {
  en: {
    translation: {
      title: "X-Sähkö",
      description:
        "X-Sähkö is a service that allows you to monitor pricing between Fixed and Spot electricity",
      info1:
        "In the service, you can view your own consumption and its cost by <b>uploading your own electricity consumption file</b><br />",
      info2:
        "We will tell you which one suits you better, <br /><b>Fixed or Exchange electricity</b>",
      info3:
        "Alternatively, you can also estimate your electricity consumption with the <b>calculator</b>",
      ...
      step2:
        "Select the property you want to monitor the electricity consumption for",
      step2ImgAlt: "Fingrid Energy Report",
      step3:
        "Select <b>Energy Reporting</b> and go to the <b>Download Information</b> window",
      step3ImgAlt: "Fingrid Energy Report",
      step4: "Select the desired time period and property",
      step4ImgAlt: "Fingrid Energy Report",
      step5:
        "Press the <b>Download</b> button. This will download the <b>electricity consumption file</b> to your device, which you can upload to the calculator",
      step6:
        "<b>Do not make any changes</b> to the file, as it may affect the calculation!",
      backButton: "Back to calculator",
      compareElectricityPrice: "Compare Electricity Price",
      introText1:
        "In the service, you can view your electricity consumption and its cost by uploading your own electricity consumption file.",
      ...
      FirePlaceUsage:
        "How often do you use fireplace in a week during the heating season?",
      ...
      OptimizeInfo:
        "The optimized price difference consists of a calculation where we transfer 25% of your daytime consumption to night and morning hours, when electricity is generally cheaper.",
      ...
      privacy: {
        ...
        header2:
          "2. Person Responsible for the Register and Contact Information",
        content2:
    ...
    translation: {
      title: "X-Sähkö",
      description:
        "X-Sähkö on palvelu, joka mahdollistaa hinnoittelun seurannan Kiinteän ja Pörssisähkön välillä",
      info1:
        "Palvelussa voit tarkastella omaa kulutustasi ja sen hintaa <br /> <b>lataamalla oman sähkönkulutus-tiedoston</b>",
      info2:
        "Me kerromme sinulle <br /> kumpi sopii sinulle paremmin, <br /><b>Kiinteä vai Pörssisähkö</b>",
      info3:
        "Vaihtoehtoisesti voit myös arvioida sähkönkulutustasi <br />  <b>laskurin avulla</b>",
      ...
      step3:
        "Valitse <b>Energy Reporting</b> ja siirry <b>Download Information</b> ikkunaan",
      step3ImgAlt: "Fingrid Energiaraportti",
      step4: "Valitse haluamasi aikaväli ja kiinteistö",
      step4ImgAlt: "Fingrid Energiaraportti",
      step5:
        "Paina <b>Download</b> painiketta. Tämä lataa <b>sähkönkulutustiedoston</b> laitteellesi, jonka voit asettaa laskuriin",
      step6:
        "<b>Ethän tee muutoksia</b> tiedostoon, se voi vaikuttaa laskentaan!",
      backButton: "Takaisin laskuriin",
      compareElectricityPrice:
      ...
      submit: "Laske",
      errorFetchingData:
        "Tietojen hakemisessa tapahtui virhe. Yritä uudelleen.",
      ...
      FirePlaceUsage:
        "Kuinka usein lämmität takan viikossa? (lämmityskauden aikana)",
      EarlyYearError:
        "Meillä ei ole pörssisähkön hintatietoja ennen vuotta 2015",
      ...
      estimatedAverageHourlySpotPrice:
        "Pörssisähkön keskimääräinen tuntihinta: ",
      ...
      FloorHeatingError:
        "Lattialämmityksen pinta-ala tulee olla suurempi kuin 0 m²",
      ...
      optimizedSpotElectricityPrice:
        "Pörssisähkö hinta, jos kulutuksesi optimoitaisiin 25% halvemmille tunneille: ",
      optimizedPriceDifference: "Optimoitu hintaero:",
      carInfo:
        "Sähköauton keskimääräinen kulutus on noin 1500-2000kWh vuodessa",
      OptimizeInfo:
        "Optimoitu hintaero perustuu laskentaan, jossa siirrämme 25% päivittäisestä kulutuksestasi yö- ja aamu tunneille, jolloin sähkö on yleensä halvempaa.",
      back: "Takaisin",
      ...
      privacy: {
        ...
        content9:
          "Koska emme kerää henkilötietoja, käyttäjillä ei ole tarvetta esittää pyyntöjä tietojensa tarkistamisesta, korjaamisesta tai poistamisesta. Mikäli sinulla on kysyttävää tietojesi käsittelystä tai haluat lisätietoja, voit ottaa yhteyttä alla mainittuun yhteyshenkilöön.",
        header10: "10. Rekisterin suojauksen periaatteet",
        content10:
          "Tekniset suojatoimet: Telemetriikkatiedot tallennetaan suojatuille palvelimille, joissa on asianmukaiset palomuurit ja salaukset.\n\nOrganisatoriset suojatoimet: Pääsy telemetriikkatietoihin on rajoitettu vain niille henkilöille, joille se on työnsä puolesta välttämätöntä Sovelluksen kehittämiseksi ja ylläpitämiseksi.",
        header11: "11. Evästeet ja seurantateknologiat",
        content11:
          "X-Sähkö-sovellus ei käytä evästeitä tai muita vastaavia seurantateknologioita käyttäjän yksilöintiin tai seurantaan. Kaikki kerätty tieto on anonyymiä ja käytetään yksinomaan Sovelluksen suorituskyvyn ja käytettävyyden parantamiseen.",
        header12: "12. Tietosuojakäytännön muutokset",
        content12:
          "Pidätämme oikeuden päivittää tätä tietosuojakäytäntöä tarvittaessa Sovelluksen kehityksen tai lainsäädännön muutosten myötä. Mahdollisista merkittävistä muutoksista tiedotetaan Sovelluksen kautta tai verkkosivustollamme. Suosittelemme käyttäjiä tutustumaan tietosuojakäytäntöön säännöllisesti.",
        header13: "13. Yhteystiedot",
        content13:
          "Jos sinulla on kysyttävää tästä tietosuojakäytännöstä tai tietojesi käsittelystä, ota yhteyttä:\n\nKaakkois-Suomen Ammattikorkeakoulu – XAMK\n\nKehitys- ja tutkimusyksikkö Active Life Lab\n\nY-tunnus: 2472908-2\n\nOsoite: PL 68 (Patteristonkatu 3)\n\n50101 Mikkeli\n\nPuhelinvaihde: +358406550555\n\nRekisteristä vastaava henkilö\n\nNimi: Tuomas Reijonen\n\nSähköposti: tuomas.reijonen@xamk.fi\n\nPuhelin: +358406550555",
      },
      chart: {
        x: "aika",
        y: "snt/kWh",
        label: "snt/kWh",
        chartTitleTodayHourly: "Tuntihinnat tänään",
        chartTitleToday15min: "15 minuutin hinnat tänään",
